...
WHERE countrylanguages.language='Italian' and countrylanguages.percentage =100;
...
countries.name AS country_name FROM cities
JOIN countries ON countries.code = cities.countrycode
WHERE countries.name='San Marino' AND NOT cities.name = 'San Marino';
...
SELECT * FROM cities
JOIN countries ON countries.code = cities.countrycode
WHERE cities.name ILIKE '%ser%' AND cities.name NOT ILIKE 'Serravalle' and countries.region='South America';
...
SELECT * FROM cities
JOIN countries ON countries.code = cities.countrycode
WHERE id IN (SELECT capital FROM countries WHERE code = 'BRA');
